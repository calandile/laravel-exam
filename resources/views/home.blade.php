...
@section('content')
    <section>
        <div class="py-96">
            <form method="POST" action="/result" class="flex items-center">
                @csrf
                <label for="simple-search" class="sr-only">Title</label>
                ...
                <button type="submit"
                    class="ml-2 rounded-lg border border-blue-700 bg-blue-700 p-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg
